...
module.exports = function(ctx) {
  ...
  hero, importBlacklistToBans, intendedOwner, ipBans, isAutobanExempt, isBlacklisted,
  isMasterName, isOwner, isPidAlive, isPlayerOnline, isRealBan, listFilesRec,
  loadAutoRotate, loadBans, loadCasinoConfig, loadFactionAudit, loadFactionConfig, loadFactionRanks,
  loadKnownPlayers, loadLastSeen, loadMenuGrants, loadMenuRoles, loadModLog, loadMutes,
  loadPlaytime, loadRoles, loadWages, log, logAction, logBan,
  logger, looksLikeLedgerEntry, matchTreeOwner, md5, menuRoleTiers, meter,
  mirrorPaths, modOnlyEmbed, ownerOnlyEmbed, paginate, parseClockTime, parseDuration,
  parseRcon, patchInteractionOutput, path, pip, postFeed, postKillFeed,
  preserveBalanceAcrossKick, punishDurationLabel, randomQuote, rankBadge, rankHasRoom, rankWeight,
  rateLimitEmbed, rateLimits, readBlacklist, reconcileBans, reconcileBlacklists, recordKnownPlayers,
  recordLastSeen, releaseSingleInstanceLock, removeBans, removeFactionRank, removeUserBlacklist, safeRead,
  safeWrite, sanitizeBanName, sanitizeId, sanitizeMessage, saveCasinoConfig, savePlaytime,
  saveRoles, saveUnbarred, saveUserBlacklist, saveWages, scheduleBanRecheck, seedKnownPlayers,
  sendRcon, sendRconBoth, sendRconRaw, serverEmoji, serverLabel, setAutoRotate,
  setFactionCap, setFactionRank, setFactionRankCap, setMenuRole, setMute, sourceBanFor,
  spawn, splitPages, successEmbed, syncAllModSave, syncPlayerLedger, textify,
  textifyChunks, unbanEverywhere, ungagEverywhere, update, upsertPermBan, upsertTempBan,
  validateConfig, warningEmbed, wouldWipeBalance, writeFactionAudit, writeGameFile, writeGameFileSingle,
  writeModLog,
  } = ctx;
