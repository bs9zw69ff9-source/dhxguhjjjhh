...
module.exports = function createCommands(ctx) {
  ...
  const ADMIN_COMMANDS = ["permban", "cleartempbans", "setroles", "givemenu", "stripmenu", "unlinkname", "setpin", "removepin", "iplookup", "manual", "adjustcaps", "donator", "staffactivity", "staffleaderboard"];
