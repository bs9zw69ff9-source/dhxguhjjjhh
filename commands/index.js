...
module.exports = function createCommands(ctx) {
  ...
  const ADMIN_COMMANDS = ["permban", "cleartempbans", "setroles", "givemenu", "stripmenu", "unlinkname", "lock", "unlock", "manual", "adjustcaps", "donator", "staffactivity", "staffleaderboard"];
