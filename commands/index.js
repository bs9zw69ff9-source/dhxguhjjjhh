...
module.exports = function createCommands(ctx) {
  ...
  const ADMIN_COMMANDS = ["permban", "cleartempbans", "setroles", "givemenu", "stripmenu", "unlinkname", "setpin", "removepin", "manual", "adjustcaps", "donator", "staffactivity", "staffleaderboard"];
